...
openai.api_key = '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'

ROOT_DIRECTORY = os.path.dirname(os.path.realpath(__file__))

# Read PDF, in the params specific page numbers to parse can be added. 
...
if __name__ == "__main__":
    ...
    pdf_text = read_pdf(f'{ROOT_DIRECTORY}/SOURCE_DOCUMENTS/French1.pdf')
